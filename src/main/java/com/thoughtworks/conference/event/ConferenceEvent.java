...
/**
 * conference event which has title,duration. It also maintains the booked time
 * of the conference event. BookedTime is computed from the event duration.
 * 
 * @author Baratamr
 *
 */
public class ConferenceEvent implements IEvent {
	...
	/**
	 * Constructor for event with id,title,duration and bookedDurationModulo i.e
	 * minimum duration booked for the smallest event
	 * 
	 * @param id
	 * @param title
	 * @param durationinMin
